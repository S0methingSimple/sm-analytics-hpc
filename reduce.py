#!/usr/bin/env python
# Originally from: https://stackoverflow.com/questions/15271599/reduce-a-list-with-operator-as-summing-each-element-in-mpi4py
# Modified to python3 Lev Lafayette, March 13 2024
import numpy as np
